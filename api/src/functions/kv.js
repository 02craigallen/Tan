...
const ALLOWED_KEYS = new Set(["ems:equipment", "ems:signoff-log", "ems:categories", "ems:locations", "fafa:extinguishers", "fafa:signoff-log", "fafa:buildings", "watchlog:entries", "ridersboard:grid", "fleet:vehicles", "fleet:defects", "incidents:log"]);
